...
def generated_design(inputA, inputB, outputD):
    ...
    worker_A1B1worker = Worker(core_fn_A1B1worker, [split_mem_col0_A[0].cons(), split_mem_col0_B[0].cons(), of_from_A1_B1_worker_to_C1_worker_0.prod(), external_eltwiseaddbf16vector], placement=tile_0_4, while_true=False, stack_size=1024, allocation_scheme='heap', trace=False, trace_events=None)
    worker_C1worker = Worker(core_fn_C1worker, [of_from_A1_B1_worker_to_C1_worker_0.cons(), join_mem_col0_D[0].prod(), external_bf16relu], placement=tile_0_2, while_true=False, stack_size=1024, allocation_scheme='heap', trace=False, trace_events=None)
    worker_A2B2worker = Worker(core_fn_A2B2worker, [split_mem_col0_A[1].cons(), split_mem_col0_B[1].cons(), of_from_A2_B2_worker_to_C2_worker_0.prod(), external_eltwiseaddbf16vector], placement=tile_0_5, while_true=False, stack_size=1024, allocation_scheme='heap', trace=False, trace_events=None)
    worker_C2worker = Worker(core_fn_C2worker, [of_from_A2_B2_worker_to_C2_worker_0.cons(), join_mem_col0_D[1].prod(), external_bf16relu], placement=tile_0_3, while_true=False, stack_size=1024, allocation_scheme='heap', trace=False, trace_events=None)
    worker_A3B3worker = Worker(core_fn_A3B3worker, [split_mem_col1_A[0].cons(), split_mem_col1_B[0].cons(), of_from_A3_B3_worker_to_C3_worker_0.prod(), external_eltwiseaddbf16vector], placement=tile_1_4, while_true=False, stack_size=1024, allocation_scheme='heap', trace=False, trace_events=None)
    worker_C3worker = Worker(core_fn_C3worker, [of_from_A3_B3_worker_to_C3_worker_0.cons(), join_mem_col1_D[0].prod(), external_bf16relu], placement=tile_1_2, while_true=False, stack_size=1024, allocation_scheme='heap', trace=False, trace_events=None)
    worker_A4B4worker = Worker(core_fn_A4B4worker, [split_mem_col1_A[1].cons(), split_mem_col1_B[1].cons(), of_from_A4_B4_worker_to_C4_worker_0.prod(), external_eltwiseaddbf16vector], placement=tile_1_5, while_true=False, stack_size=1024, allocation_scheme='heap', trace=False, trace_events=None)
    worker_C4worker = Worker(core_fn_C4worker, [of_from_A4_B4_worker_to_C4_worker_0.cons(), join_mem_col1_D[1].prod(), external_bf16relu], placement=tile_1_3, while_true=False, stack_size=1024, allocation_scheme='heap', trace=False, trace_events=None)
    worker_A5B5worker = Worker(core_fn_A5B5worker, [split_mem_col2_A[0].cons(), split_mem_col2_B[0].cons(), of_from_A5_B5_worker_to_C5_worker_0.prod(), external_eltwiseaddbf16vector], placement=tile_2_4, while_true=False, stack_size=1024, allocation_scheme='heap', trace=False, trace_events=None)
    worker_C5worker = Worker(core_fn_C5worker, [of_from_A5_B5_worker_to_C5_worker_0.cons(), join_mem_col2_D[0].prod(), external_bf16relu], placement=tile_2_2, while_true=False, stack_size=1024, allocation_scheme='heap', trace=False, trace_events=None)
    worker_A6B6worker = Worker(core_fn_A6B6worker, [split_mem_col2_A[1].cons(), split_mem_col2_B[1].cons(), of_from_A6_B6_worker_to_C6_worker_0.prod(), external_eltwiseaddbf16vector], placement=tile_2_5, while_true=False, stack_size=1024, allocation_scheme='heap', trace=False, trace_events=None)
    worker_C6worker = Worker(core_fn_C6worker, [of_from_A6_B6_worker_to_C6_worker_0.cons(), join_mem_col2_D[1].prod(), external_bf16relu], placement=tile_2_3, while_true=False, stack_size=1024, allocation_scheme='heap', trace=False, trace_events=None)
    worker_A7B7worker = Worker(core_fn_A7B7worker, [split_mem_col3_A[0].cons(), split_mem_col3_B[0].cons(), of_from_A7_B7_worker_to_C7_worker_0.prod(), external_eltwiseaddbf16vector], placement=tile_3_4, while_true=False, stack_size=1024, allocation_scheme='heap', trace=False, trace_events=None)
    worker_C7worker = Worker(core_fn_C7worker, [of_from_A7_B7_worker_to_C7_worker_0.cons(), join_mem_col3_D[0].prod(), external_bf16relu], placement=tile_3_2, while_true=False, stack_size=1024, allocation_scheme='heap', trace=False, trace_events=None)
    worker_A8B8worker = Worker(core_fn_A8B8worker, [split_mem_col3_A[1].cons(), split_mem_col3_B[1].cons(), of_from_A8_B8_worker_to_C8_worker_0.prod(), external_eltwiseaddbf16vector], placement=tile_3_5, while_true=False, stack_size=1024, allocation_scheme='heap', trace=False, trace_events=None)
    worker_C8worker = Worker(core_fn_C8worker, [of_from_A8_B8_worker_to_C8_worker_0.cons(), join_mem_col3_D[1].prod(), external_bf16relu], placement=tile_3_3, while_true=False, stack_size=1024, allocation_scheme='heap', trace=False, trace_events=None)
